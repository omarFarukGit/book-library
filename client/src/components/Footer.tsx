    ...
    <footer className=" pt-20 pb-10 ">
      <section className="mx-auto w-11/12 gap-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  py-8 lg:grid-cols-4 ">
        ...
        <nav>
          ...
          <p className="text-sm text-white/80">
            Sylhet, Sunamganj, Dowarabazar-3070
          </p>
          <p className="text-sm text-white/80">Villave: Tengratilla </p>
          <p className="text-sm text-white/80">Road: Banglabazar</p>
          <p className="text-sm text-white/80">Phone: +8801887344542</p>
        </nav>
        <nav>
          ...
          <fieldset className="w-80">
            ...
            >
              <textarea
                ...
                className="w-full h-20 border rounded-md border-white/10 p-2"
      ...
      <div className="flex justify-between w-11/12 gap-5 mx-auto text-[12px] px-20 py3">
        ...
        <ul className="flex gap-3 flex-col lg:flex-row">
          <li className="link text-[12px] link-hover text-white/70 hover:text-blue-400">
            Privacy Policy{" "}
          </li>
          <li className="link text-[12px] link-hover text-white/70 hover:text-blue-400">
            Terms of Service
